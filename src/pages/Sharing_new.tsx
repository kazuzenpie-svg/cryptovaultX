...
import { Share2, Users, Send, UserPlus, Shield } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              Control exactly what data is shared and for how long.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <ShareDataDialog>
              <Card className="glass-card hover:bg-card/80 transition-colors cursor-pointer group">
                <CardContent className="p-6 text-center space-y-3">
                  ...
                  <div>
                    <h3 className="font-semibold">Share Data</h3>
                    <p className="text-sm text-muted-foreground">Grant access to your trading data</p>
                  </div>
                </CardContent>
              </Card>
            </ShareDataDialog>
            ...
            <Card className="glass-card">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <div>
                  <h3 className="font-semibold">{grants.length} Active Shares</h3>
                  <p className="text-sm text-muted-foreground">Users with access to your data</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <div>
                  <h3 className="font-semibold">{incomingRequests.length + outgoingRequests.length} Pending</h3>
                  <p className="text-sm text-muted-foreground">Requests awaiting response</p>
                </div>
              </CardContent>
            </Card>
          </div>
